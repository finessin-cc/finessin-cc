...
Practicing with hands-on labs and CTF-style challenges, exploring privilege escalation, enumeration, and basic attack techniques
Writing structured notes in my own style to better understand and retain knowledge
...
### Goals
Become confident in real-world security scenarios
Develop a strong technical foundation
Grow into a professional role in cybersecurity
## Note
This profile is part of my learning journey - everything here represents progress, experimentation, and continuous improvement.
<!--
**finessin-cc/finessin-cc** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
